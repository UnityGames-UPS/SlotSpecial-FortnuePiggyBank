...
namespace Coffee.UIExtensions
{
...
#endif
	{
		...
		{
			StopAllCoroutines();
			StartCoroutine(CoPlay(duration, AnimatorUpdateMode.Normal, false));
		}
		...
		{
			StopAllCoroutines();
			StartCoroutine(CoPlay(duration, updateMode, false));
		}

		/// <summary>
		/// Play effect in loop.
		/// </summary>
		public void PlayLoop(float duration = 1f)
		{
			PlayLoop(duration, AnimatorUpdateMode.Normal);
		}

		/// <summary>
		/// Play effect in loop.
		/// </summary>
		public void PlayLoop(float duration, AnimatorUpdateMode updateMode)
		{
			StopAllCoroutines();
			StartCoroutine(CoPlay(duration, updateMode, true));
		}

		/// <summary>
		/// Stop effect and reset location to 0.
		/// </summary>
		public void Stop()
		{
			StopAllCoroutines();
		...
		IEnumerator CoPlay(float duration, AnimatorUpdateMode updateMode = AnimatorUpdateMode.Normal, bool loop = false)
		{
			do
			{
				float time = 0;
